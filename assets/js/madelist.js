...
function mostrarQuejasPendientes() {
    ...
    db.collection('denuncias').where('estatus', '==', 'Finalizada').orderBy('createdAt', 'desc')
                .get()
                .then(querySnapshot => {
...
function filtrarQuejasPorTipo(tipo) {
    ...
    if(tipo === "0") {
        ...
        db.collection('denuncias').where('estatus', '==', 'Finalizada').where('tipoReporte', '==', tipo).orderBy('createdAt', 'desc')
                .get()
                .then(querySnapshot => {
